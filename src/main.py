...
def whats_new(session):
    """Парсер для вывода новостей о Python"""
...
def latest_versions(session):
    """Парсер для информации о версиях Python """
...
def download(session):
    """
    Парсер для нахождения и
    скачивания файла по документации Python
    """
...
def pep(session):
    """парсиг статусов документов PEP"""
    stas = []
